...
function fetchRegisteredCourses($connection, $userID){
  $sql = "SELECT * FROM registeredCourses WHERE userID='$userID' ";
...
$courses = fetchRegisteredCourses($connection, $userID);
